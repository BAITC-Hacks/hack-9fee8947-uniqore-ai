# Tyuin — распутываем финансовые связи
...
Tyuin — рабочее пространство для исследования финансовых связей. Оно помогает аналитику увидеть движение средств между участниками, разобраться в структуре групп и определить, кого проверить первым.
...
[Запуск и деплой](#запустить-и-проверить) · [Сценарий аналитика](#проверить-сценарий-аналитика) · [Как работает](#как-получается-результат) · [Результаты](#демонстрация-на-данных-хакатона) · [Ограничения и развитие](#ограничения-и-следующий-масштаб)

![Рабочее пространство Tyuin: клиенты, направленный граф и досье связаны выбором участника](docs/finance/screenshots/demo-client-filters-1280.png)
...
Текущий входной контракт — три Parquet со схемой кейса: один банк, июль 2026, исходящий обход на четыре колена и суммы от 5 000 KZT. Эти условия проверяются загрузчиком. Подключение других периодов, валют и источников потребует адаптации контракта и правил; универсальная загрузка произвольных данных пока не реализована. Внешние входы, остатки и продолжение границы неизвестны. Нет эталонных ролей, поэтому accuracy, recall и доказанная эффективность расследования не заявляются. Сообщества не равны преступным группам; все назначения — гипотезы.
...
**Следующий шаг применения:** настраиваемый период, валюта и глубина наблюдения, загрузка собственных данных в согласованном формате и проверка правил на размеченных примерах. Это направление развития для финансового мониторинга и смежных расследований; результат на новых наборах ещё не измерен.
