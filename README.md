...
<img src="docs/brand/tyuin/v1.0.0/assets/tyuin-logo.png" alt="Tyuin — рысь-сыщик" width="320" />

[Бренд, логотип и исходные скетчи](docs/brand/README.md) · [Проверка ребрендинга](docs/brand/tyuin/v1.0.0/validation.md)
...
![Рабочий интерфейс: очередь, граф и досье](docs/brand/tyuin/v1.0.0/previews/workbench.png)
