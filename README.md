...
Первоначальная проверка установки выполнена в отдельном виртуальном окружении и копии проекта на macOS. Дополнительно проверен Docker-контейнер Linux amd64: сборка, запуск, API, CSV и 26 тестов; [результаты](docs/deployment/brev.md#проверка-конфигурации). Запуск Python напрямую в Windows не проверялся; активация окружения там отличается: `.venv\Scripts\activate`.
