...
Онлайн-демо использует алгоритм 1.0.0 и снимок `ad6239d9995448b0`; новые сценарии интерфейса и алгоритм 1.1.0 из текущей `main` ещё не развёрнуты. Инструкции локального запуска и сценарии ниже относятся к текущему коду репозитория.
