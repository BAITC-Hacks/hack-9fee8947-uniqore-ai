...
Проверка установки выполнена в отдельном виртуальном окружении и копии проекта: macOS arm64 (Python 3.12.1) и Windows 11 x64 (Python 3.14.5, PowerShell, чистый `git clone` с `core.autocrlf=true`). Linux в этой итерации не проверялся.
