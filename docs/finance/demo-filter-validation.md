...
Пятиминутное выступление и минутное объяснение трёх заданных проверяющим gid с человеком ещё не измерены; эти критерии остаются открытыми в [спецификации](../specs/finance-demo-rehearsal.md).

## Пользовательская приёмка

23.09.2026 пользователь подтвердил локальную приёмку версии **`1b38d0e1740a40f97c4a0e0584a0ae06b0691d14`** и разрешил слияние: «проверил, мержи». Код этой версии совпадает с проверенным `a91e3de`; различия — документы и доказательства проверки. Последующая фиксация приёмки меняет только документацию: diff, содержание и относительные ссылки проверены; код принятой версии и контрольные суммы оригиналов неизменны. Приёмка UX не заменяет замеры двух упражнений с человеком.
