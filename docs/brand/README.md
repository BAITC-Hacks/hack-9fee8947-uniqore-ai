...
<img src="tyuin/v1.0.2/assets/tyuin-logo.png" alt="Tyuin — горизонтальный логотип с выровненной надписью" width="420" />

Текущая редакция горизонтального логотипа — **v1.0.2**: надпись выровнена по высоте, между рысью и названием добавлен небольшой зазор. Персонаж и отдельная иконка сохраняют выбранный облик.
...
| Материал | Файл |
|---|---|
| Горизонтальный логотип с выровненной надписью, прозрачный PNG | [tyuin-logo.png](tyuin/v1.0.2/assets/tyuin-logo.png) |
| Рысь без надписи, прозрачный PNG | [tyuin-icon.png](tyuin/v1.0.0/assets/tyuin-icon.png) |
| Текущая компоновка и проверка | [v1.0.2](tyuin/v1.0.2/README.md) |
...
| Контрольные суммы | [v1.0.0](tyuin/v1.0.0/SHA256SUMS) · [v1.0.1](tyuin/v1.0.1/SHA256SUMS) · [v1.0.2](tyuin/v1.0.2/SHA256SUMS) |
| Проверка ребрендинга и экран приложения | [Отчёт](tyuin/v1.0.2/validation.md) |
